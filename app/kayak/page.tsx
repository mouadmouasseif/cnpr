...
const activities = [
  {
    ...
    reservationLink: 'https://planning.izidoor.io/booking/516/538/products?showCourseDetailsModal=true&selectedTemplateProductId=21278',
  },
 
  {
    name: 'Kayak privatisé',
    image: '/Image/kayak.jpg',
    ...
    reservationLink: 'https://planning.izidoor.io/booking/516/538/products?showCourseDetailsModal=true&selectedTemplateProductId=21350',
  },
  {
    name: 'Demi Journée Kayak',
    image: '/Image/kayak.jpg',
    description: 'asse une agréable Journée chez le club nautique plage de rabat 3h de Kayak vous mette plaisir!.',
    reservationLink: 'https://planning.izidoor.io/booking/516/538/products?showCourseDetailsModal=true&selectedTemplateProductId=21441',
  },
]
